        ...
        <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl border-2 border-green-200 shadow-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {songs.map((song, index) => (
                    <div key={index} className="bg-white rounded-2xl border-2 border-green-200 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 min-h-[320px] flex flex-col overflow-hidden">
                            ...
                            {song.chordProgression && song.chordProgression.length > 0 && (
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {song.chordProgression.map((chord, chordIndex) => (
                                            <span
                                                key={chordIndex}
                            ...
                            {song.youtubeUrl ? (
                                <div className="mt-6 pt-4 border-t border-gray-100">
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 hover:scale-105 transform shadow-md"
                                    >
